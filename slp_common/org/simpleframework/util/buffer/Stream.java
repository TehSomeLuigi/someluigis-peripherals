...
/**
 * The <code>Stream</code> interface is used to represent anything that can be
 * streamed. Typically this is used to represent a region of memory that can be
 * read through an <code>InputStream</code> object. Representing an object as a
 * stream ensures it can each time the input stream is acquired it reads from
