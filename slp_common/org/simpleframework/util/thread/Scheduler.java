...
/**
 * The <code>Scheduler</code> object is used to schedule tasks for execution.
 * This queues the task for the requested period of time before it is executed.
 * It ensures that the delay is adhered to such that tasks can be timed for
 * execution in an accurate way.
 * 
...
public class Scheduler implements Executor {
    ...
    /**
     * Constructor for the <code>Scheduler</code> object. This will create a
     * scheduler with a fixed number of threads to use before execution.
    ...
    /**
     * This will execute the task within the executor immediately as it uses a
     * delay duration of zero milliseconds. This can be used if the scheduler is
     * to be used as a thread pool.
     * 
     * @param task
    ...
    /**
     * This will execute the task within the executor after the time specified
     * has expired. If the time specified is zero then it will be executed
     * immediately. Once the scheduler has been stopped then this method will no
     * longer accept runnable tasks.
     * 
     * @param task
     *            this is the task to schedule for execution
     * @param delay
