...
/**
 * This is a <code>SocketWrapper</code> objects that represents a TCP socket
 * connections. This contains a map that allows attributes to be associated with
 * the client connection. Attributes such as security certificates or other
 * transport related details can be exposed to the <code>Request</code> using
 * the socket attribute map.
 * <p>
 * This provides the connected <code>SocketChannel</code> that can be used to
 * receive and response to HTTP requests. The socket channel must be selectable
 * and in non-blocking mode. If the socket is not in a non-blocking state the
...
public class SocketWrapper implements Socket {
    ...
    /**
     * This creates a <code>SocketWrapper</code> from a socket channel. Any
     * implementations of the object may use this constructor to ensure that all
     * the data is initialized.
     * 
     * @param channel
     *            the socket channel that is used as the transport
     * @param trace
    ...
    /**
     * This creates a <code>SecureSocket</code> from a socket channel. Any
     * implementations of the object may use this constructor to ensure that all
     * the data is initialized.
     * 
     * @param channel
    ...
    /**
     * This is used to acquire the SSL engine used for HTTPS. If the socket is
     ...
     * socket. The attributes map is used to maintain details about the
