...
/**
 * The <code>SocketTrace</code> is used to wrap an trace for safety. Wrapping an
 * trace in this way ensures that even if the trace is badly written there is
 * little chance that it will affect the operation of the server.
 * 
...
class SocketTrace implements Trace {
    ...
    /**
     * Constructor for the <code>SocketTrace</code> object. This will create a
     * trace object that wraps the one provided. If the provided trace is null
     * then this will simply ignore all events.
     * 
     * @param trace
