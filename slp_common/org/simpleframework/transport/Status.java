...
/**
 * The <code>Status</code> enumeration is used to determine what action is
 * required within a negotiation. This allows the negotiation to control the
 * selection for read and write ready operations. Also, status signals
