...
/**
 * The <code>TransportEvent</code> enum represents various events that can occur
 * with the transport. Events that are available here are typically those that
 * refer to low level I/O operations within the server. If a <code>Trace</code>
 * has been associated with the socket connection then it will receive these
