...
/**
 * The <code>CancelAction</code> object is used to represent a task that can be
 * executed to cancel an operation. This is used in the place of a normal
 * <code>Operation</code> to pass for execution when the operation has expired
 * before the I/O event is was interested in occurred. Before this is executed
 * the operation is removed from selection.
 * 
...
class CancelAction implements Action {
    ...
    /**
     * Constructor for the <code>Cancellation</code> object. This is used to
     * create a runnable task that delegates to the cancel method of the
     * operation. This will be executed asynchronously by the executor after
     * being removed from selection.
     * 
     * @param action
     *            this is the task that is to be canceled by this
     */
    ...
    /**
     * This method is executed by the <code>Executor</code> object if the
     * operation expires before the required I/O event(s) have occurred. It is
     * typically used to shutdown the socket and release any resources
