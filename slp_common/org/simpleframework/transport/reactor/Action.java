...
/**
 * The <code>Action</code> object is used to represent an action that the
 * distributor is to process. This contains the operation and the required I/O
 * events as an integer bit mask. When an operation is considered ready it will
 * be handed to an executor to execute.
 * 
