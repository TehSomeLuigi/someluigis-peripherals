...
/**
 * The <code>Distributor</code> object is used to execute operations that have
 * an interested I/O event ready. This acts much like a scheduler would in that
 * it delays the execution of the operations until such time as the associated
