...
/**
 * The <code>RequestLine</code> is used to represent a HTTP request line. The
 * methods provided for this can be used to provide easy access to the
 * components of a HTTP request line. For the syntax of a HTTP request line see
 * RFC 2616.
 * 
