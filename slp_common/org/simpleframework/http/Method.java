...
/**
 * The <code>Method</code> interface contains the common HTTP methods that are
 * sent with a request. This only contains those methods that have been defined
 * within the RFC 2616 specification. These are defined here for convenience and
