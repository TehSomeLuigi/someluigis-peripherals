...
/**
 * The <code>Status</code> enumeration is used to specify status codes and the
 * descriptions of those status codes. This is a convenience enumeration that
 * allows users to acquire the descriptions of codes by simply providing the
 * code. Also if the response state is known the code and description can be
 * provided to the client.
 * <p>
 * The official HTTP status codes are defined in RFC 2616 section 10. Each set
 * of status codes belongs to a specific family. Each family describes a
 * specific scenario. Although it is possible to use other status codes it is
 * recommended that servers restrict their status code responses to those
...
public enum Status {
    ...
    /**
     * Constructor for the <code>Status</code> object. This will create a status
     * object that is used to represent a response state. It contains a status
     * code and a description of that code.
     * 
     * @param code
     *            this is the code that is used for this status
     * @param description
    ...
    /**
     * This is used to acquire the code of the status object. This is used in
     * the HTTP response message to tell the client what kind of response this
     * represents. Typically this is used to get a code for a known response
    ...
    /**
     * This is used to provide the status description. The description is the
     * textual description of the response state. It is used so that the
     * response can be interpreted and is a required part of the HTTP response
     * combined with the status code.
     * 
     ...
     * 
     * @param code
     *            this is the code to resolve the description for
     * 
     * @return the description associated by this status instance
     */
