 ...
 * <code>Response</code> object can be wrapped in a filtering proxy object. This
 * allows a container to interact with an implementation of this with overridden
 * methods providing specific functionality. the <code>Response</code> object in
 ...
 * </pre>
 * 
 * The above is an example of how the <code>ResponseWrapper</code> can be used
 * to provide extra functionality to a <code>Response</code> in a transparent
 * manner. Such an implementation could apply a Content-Encoding header and
 * compress the response for performance over a slow network. Filtering can be
 * applied with the use of layered <code>Container</code> objects.
 * 
...
public class ResponseWrapper implements Response {
    ...
    /**
     * Constructor for <code>ResponseWrapper</code> object. This allows the
     * original <code>Response</code> object to be wrapped so that adjustments
     * to the behavior of a request object handed to the container can be
     * provided by a subclass implementation.
     * 
     * @param response
    ...
    public void setDescription(String text) {
        this.response.setDescription(text);
    }
    ...
    public void addValue(String name, String value) {
        this.response.addValue(name, value);
    }
    ...
    public void addInteger(String name, int value) {
        this.response.addInteger(name, value);
    }
    ...
    public void setInteger(String name, int value) {
        this.response.setInteger(name, value);
    }
    ...
    public void setLong(String name, long value) {
        this.response.setLong(name, value);
    }
    ...
    public String getValue(String name) {
        return this.response.getValue(name);
    }
    ...
    public int getInteger(String name) {
        return this.response.getInteger(name);
    }
    ...
    public long getDate(String name) {
        return this.response.getDate(name);
    }
    ...
    public List<String> getValues(String name) {
        return this.response.getValues(name);
    }
    ...
    public Cookie setCookie(String name, String value) {
        return this.response.setCookie(name, value);
    }
     ...
     * clients and closed for HTTP/1.0 clients. The <code>OutputStream</code>
     * issued must be thread safe so that it can be used in a concurrent
     * environment.
     * 
    ...
    public OutputStream getOutputStream(int size) throws IOException {
        return this.response.getOutputStream(size);
    }
     ...
     * <p>
     * Implementations of the <code>Response</code> must guarantee that this can
     * be invoked repeatedly without effecting any issued
    ...
    public PrintStream getPrintStream(int size) throws IOException {
        return this.response.getPrintStream(size);
    }
    ...
    public WritableByteChannel getByteChannel(int size) throws IOException {
        return this.response.getByteChannel(size);
    }
