...
/**
 * The <code>EmptyProducer</code> object is a producer used if there is not
 * response body to be delivered. Typically this is used when the HTTP request
 * method is HEAD or if there is some status code sent to the client that does
...
class EmptyProducer implements Producer {
    ...
    /**
     * Constructor for the <code>EmptyProducer</code> object. Once created this
     * producer will signal the kernel the the next request is ready to read
     * from the HTTP pipeline as there is no content to be delivered with this
     * producer object.
     * 
     * @param sender
    ...
    /**
     * This method performs no operation. Because this producer is not required
     * to generate a response body this will ignore all data that is provided to
     ...
     */
    @Override
    public void produce(ByteBuffer buffer, int off, int size)
            throws IOException {
        return;
    }
