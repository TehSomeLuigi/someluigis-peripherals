...
/**
 * The <code>Initiator</code> represents an interface in to the main processor
 * for the server kernel. It is used to read and parse a new HTTP request from
 * the connected socket and dispatch that request to the <code>Container</code>
 * when ready. All channels begin at the initiator, and when a request has
 * finished it is passed back in to the initiator to further process requests
