 ...
 * processing a HTTP transaction. Here each phase of processing has a single
 * event to represent it. If a <code>Trace</code> object has been associated
 * with the connection then the server will notify the trace when the connection
 * enters a specific phase of processing.
 * 
