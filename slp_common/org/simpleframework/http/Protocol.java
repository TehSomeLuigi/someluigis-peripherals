...
/**
 * This represents the HTTP header names defined in RFC 2616. It can be used to
 * set and get headers safely from the <code>Request</code> and
 * <code>Response</code> objects. This is used internally by the HTTP server to
 * parse the incoming requests and also to submit response values for each
 * conversation.
 * <p>
 * In addition to the header names this also contains some common HTTP header
 * value tokens. These are provided for convenience and can be used to ensure
