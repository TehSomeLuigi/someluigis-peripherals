...
public interface Header extends Segment {
     ...
     * version corresponds to the major protocol type, that is the 1 of a
     * HTTP/1.1 version string. Typically the major type is 1, by can be 0 for
     * HTTP/0.9 clients.
     * 
     ...
     * version corresponds to the minor protocol type, that is the 0 of a
