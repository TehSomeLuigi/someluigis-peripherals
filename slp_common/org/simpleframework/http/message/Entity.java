...
/**
 * The <code>Entity</code> object is used to represent the HTTP entity received
 * from the client. The entity contains a header and body as well as the
 * underlying <code>Channel</code> for the connection. If there is no body with
 * the entity this will provide an empty body object which provides a zero
