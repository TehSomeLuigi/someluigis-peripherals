...
/**
 * The <code>PartConsumer</code> object is used to consume a part from a part
 * list. A part consists of a header and a body, which can be either a simple
 * chunk of data or another part list. This must be able to cope with either a
 * simple body or a part list.
 * 
...
class PartConsumer implements Consumer {
    ...
    /**
     * Constructor for the <code>PartConsumer</code> object. This is used to
     * create a consumer used to read the contents of a part and the boundary
     * that terminates the content. Any parts that are created by this are added
     * to the provided part list.
     * 
     * @param allocator
     *            this is the allocator used to creat buffers
     * @param series
     *            this is the part list used to store the parts
     * @param terminal
     *            this is the terminal token for the part
     */
    ...
    /**
     * This is used to create a new body consumer used to consume the part body
     * from for the list. This will ensure that the part data is created based
     * on the part header consumed. The types of part supported are part lists
     * and part body.
     * 
    ...
    /**
     * This is used to consume the part body from the cursor. This initially
     * reads the body of the part, which represents the actual payload exposed
     * via the <code>Part</code> interface once the payload has been consumed
     * the terminal is consumed.
     * 
     * @param cursor
     *            this is the cursor to consume the body from
     */
    @Override
    ...
    public boolean isFinished() {
        if (this.body != null) return this.body.isFinished();
        return false;
    }
}
