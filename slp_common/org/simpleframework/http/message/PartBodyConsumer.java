...
/**
 * The <code>PartBodyConsumer</code> object is used to consume a part the
 * contents of a multipart body. This will consume the part and add it to a part
 * list, once the part has been consumed and added to the part list a terminal
 * token is consumed, which is a carriage return and line feed.
 * 
...
class PartBodyConsumer implements BodyConsumer {
    ...
    /**
     * Constructor for the <code>PartBodyConsumer</code> object. This is used to
     ...
     */
    public PartBodyConsumer(Allocator allocator, Segment segment,
            byte[] boundary) {
